...
namespace Library_Management.DTO
{
    class DTO_ThanhVien
    {
        ...
        public DTO_ThanhVien(string id, string name, string CMND, string DiaChi, string phone, DateTime NgayDK, DateTime NgayHH, DateTime Birth, string IDLTV, string Mail, string anh, string gioitinh)
        {
